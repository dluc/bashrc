...
# echo $USER ' access on:' `date` `who` | mail -s "ALERT! Root Access from `who | awk '{print $5}'`" me@domain.tld
...
case $TERM in
	xterm*|screen)
		...
		#export PROMPT_COMMAND='tabname="\033]0;${HOSTNAME}\007";echo -ne "$tabname"'
		;;
	*)
		;;
esac
